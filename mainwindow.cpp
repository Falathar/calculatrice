    ...
    : QMainWindow(parent)
{
    ...
    listButtons[0]->setGeometry(QRect(QPoint(100, 350),    // valeur 1
                                      QSize(200, 50)));

    listButtons[1]->setGeometry(QRect(QPoint(100, 300),    // valeur 1
                                      QSize(200, 50)));


    listButtons[2]->setGeometry(QRect(QPoint(300, 300),
                                      QSize(200, 50)));     // valeur=2

    listButtons[3]->setGeometry(QRect(QPoint(500, 300),
                                      QSize(200, 50)));    // valeur 3

    listButtons[4]->setGeometry(QRect(QPoint(100, 250),
                                      QSize(200, 50)));     // valeur 4

    listButtons[5]->setGeometry(QRect(QPoint(300, 250),
                                      QSize(200, 50)));   // valeur 5

    listButtons[6]->setGeometry(QRect(QPoint(500, 250),   // valeur 6
                                      QSize(200, 50)));

    listButtons[7]->setGeometry(QRect(QPoint(100, 200),   // valeur7
                                      QSize(200, 50)));

    listButtons[8]->setGeometry(QRect(QPoint(300, 200),
                                      QSize(200, 50)));    // valeur 8

    listButtons[9]->setGeometry(QRect(QPoint(500, 200),
